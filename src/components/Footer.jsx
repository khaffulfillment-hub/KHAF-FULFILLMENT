...
function Footer() {
  ...
  return (
    <footer className="bg-green-50/30 backdrop-blur-xl border-t border-green-200/50 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.name}>
                  <a href={link.href} className="text-gray-600 hover:text-green-600 font-medium transition-colors duration-300">
                    {link.name}
                  </a>
                </li>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-green-200/60 flex flex-col sm:flex-row justify-between items-center">
